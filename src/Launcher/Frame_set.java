 ...
 * @author aniss
 */
public class Frame_set extends javax.swing.JFrame {
       Launcher launcher ;
    /**
     * Creates new form Frame_2
     */
    public Frame_set(Launcher launcher) {
        this.launcher = launcher;
        this.launcher.set_Frame_set(this);
        initComponents();
    }
    ...
    private void RDVActionPerformed(java.awt.event.ActionEvent evt) {                                    
         EDGE.setEnabled(false);
      launcher.set_Rendez_vous();
    }                                   
